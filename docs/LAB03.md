...
deverá receber o montante, bem como o motivo pelo qual ele está sendo reconhecido  
(uma mensagem aberta, obrigatória).
...
Empresas que desejam realizar parceria também devem se cadastrar no sistema,  
incluindo as vantagens que deseja oferecer e o custo de cada uma delas (em moedas).  
...
produzido para a primeira release, comparando-os com os modelos descritos  
inicialmente, bem como apresentando as modificações inseridas para o funcionamento  
adequado do software (conforme a especificação anterior). Além disso, ao final da  
Sprint 03, cada grupo deverá apresentar um tutorial das tecnologias escolhidas para  
desenvolver o sistema. A ideia é promovermos um salão de tecnologias na aula. Cada  
A apresentação deve ter \~20min de duração. Ela fará parte da especificação da Sprint 03\.
...
Para este projeto, utilize o template de **README.md** disponível aqui:  
[https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-](https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-)  
[software/blob/main/TEMPLATES/template\_README.md](https://github.com/joaopauloaramuni/laboratorio-de-desenvolvimento-de-)
